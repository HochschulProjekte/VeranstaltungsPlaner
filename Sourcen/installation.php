            ...
            <div id="install-card">
                ...
                <form id="install-form" action="./installDatabase.php" method="post">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="install-hostname" name="install-hostname"
                               placeholder="Hostname">
                    </div>

                    <div class="input-group">
                        <div class="input-group-addon"><i class="fa fa-database"></i></div>
                        <input type="text" class="form-control" id="install-database" name="install-database"
                               placeholder="Database">
                    </div>

                    <div class="input-group">
                        <div class="input-group-addon"><i class="fa fa-user"></i></div>
                        <input type="text" class="form-control" id="install-username" name="install-username"
                               placeholder="Username">
                    </div>

                    <div class="input-group">
                        <div class="input-group-addon"><i class="fa fa-key"></i></div>
                        <input type="text" class="form-control" id="install-password" name="install-password"
