                            ...
                            <form action="#" method="post" id="needs-validation">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="input-group" style="margin-bottom: 5px">
                                        <div class="input-group-addon event-input-icon"><i class="fa fa-clock-o"></i>
                                        </div>
                                        <?php
                                        echo '
                                            ...
                                            ';
                                        ?>
                                        <select class="form-control" id="myprojectweek-position" name="position"
                                                required>
                                            <?php
                                            for ($i = 1; $i <= 10; $i++) {
                                    ...
                                    <div class="input-group" style="margin-bottom: 5px">
                                        <div class="input-group-addon event-input-icon"><i
                                                    class="fa fa-graduation-cap"></i></div>
                                        <input type="text" class="form-control" id="myprojectweek-participants"
                                               name="maxParticipants" placeholder="Max. Teilnehmer" value="" required>
                                    </div>
                                    ...
                                    <table class="table table-sm">
                                        ...
                                        foreach ($events as $event) {
                                            echo '
                                                    ...
                                                    <tr>
                                                        <td><input type="radio" name="eventId" value="' . $event->getId() . '" onclick="setMaxParticipantsTo(' . $event->getMaxParticipants() . ')" /></td>
                                                        <td>' . $event->getName() . '</td>
                    ...
                    foreach ($controller->getProjectWeek()->getProjectWeekEntries() as $entry) {
                        echo '
                                    <tr>
                                        ...
                                        <td>' . PositionMapping::mapUntil($entry->getPosition(), $entry->getEvent()->getLength()) . '</td>
                                        <td>' . $entry->getEvent()->getName() . '</td>
                                        <td>' . $entry->getEvent()->getPersonnalManager() . '</td>
